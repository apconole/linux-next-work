...
struct page {
	...
	struct {
		...
		union {
			/*
			 * If the page is neither PageSlab nor mappable to
			 * userspace, the value stored here may help determine
			 * what this page is used for.  See page-flags.h for a
			 * list of page types which are currently stored here.
			 */
			RH_KABI_EXTEND(unsigned int page_type)
