...
static struct trace_kprobe* trace_kprobe(struct ftrace_event_call *call)
{
...
static int kprobe_event_define_fields(struct ftrace_event_call *event_call)
{
	int ret, i;
	struct kprobe_trace_entry_head field;
	struct trace_kprobe *tk = trace_kprobe(event_call);
...
{
	struct trace_kprobe *tk = trace_kprobe(event);
...
void destroy_local_trace_kprobe(struct ftrace_event_call *event_call)
{
	struct trace_kprobe *tk;
